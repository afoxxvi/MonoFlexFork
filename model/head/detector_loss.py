...
class Loss_Computation():
    ...
    def prepare_targets(self, targets):
        ...
        wh = torch.stack([t.get_field("wh") for t in targets])
        # 3d detection
        ...
        return_dict = dict(cls_ids=cls_ids, target_centers=target_centers, bboxes=bboxes, wh=wh,
                           keypoints=keypoints,
    ...
    def freeze_call(self, predictions, targets, iters = None, max_iter = None, return_depths = False):
        ...
        targets_heatmap, targets_kpt_heatmap, targets_variables = self.prepare_targets(targets)
