...
_C.DATASETS.KITTI_TYPE = 'original' # ['original', 'ground']
_C.DATASETS.FAST = False
...
_C.MODEL.HEAD.BOT_CENTER = False

_C.MODEL.HEAD.DENSE_DEPTH = False
_C.MODEL.HEAD.DENSE_DEPTH_SAMPLE_NUM = 20
_C.MODEL.HEAD.DENSE_DEPTH_SAMPLING_METHOD = 'grid'
_C.MODEL.HEAD.DENSE_DEPTH_SAMPLING_NUM_TYPE = 'fixed'

_C.MODEL.HEAD.DENSE_SPARSE = False
_C.MODEL.HEAD.DIRECT_3D_LOSS = False
_C.MODEL.HEAD.DIRECT_3D_LOSS_WEIGHT = 1.0
_C.MODEL.HEAD.DIRECT_3D_LOSS_SCHED = 'normal' # ['normal', 'sigmoid']

_C.MODEL.HEAD.SEPRATE_DEPTH_CHANNELS = False

_C.MODEL.HEAD.ADD_GROUND_DEPTH = False
_C.MODEL.HEAD.LOAD_MODEL_META = True
_C.MODEL.HEAD.DETACH_GROUND_DEPTH = True
_C.MODEL.HEAD.USING_GROUND_DEPTH_INFER = False
_C.MODEL.HEAD.GROUND_DEPTH_LOSS_WEIGHT = 1.0
_C.MODEL.HEAD.ONLY_FIVE_GDPTS = False
_C.MODEL.HEAD.GD_DEPTH_DECODE_MODE = 'exp' # or linear
_C.MODEL.HEAD.GD_DEPTH_DECODE_POS = 'after'  # ['before', 'after']
_C.MODEL.HEAD.DILATED_GROUND_DEPTH = False  # ['before', 'after']

_C.MODEL.HEAD.GD_XY = False
_C.MODEL.HEAD.GD_DEPTH_COORD_CONV = False
_C.MODEL.HEAD.DETACH_SOFT_DEPTH_COMBINE_TRAINING = False
_C.MODEL.HEAD.UNCERTAINTY_ALIGN = False
_C.MODEL.HEAD.UNCERTAINTY_ALIGN_LOSS_WEIGHT = 1.0
_C.MODEL.HEAD.ONLY_GROUND_DEPTH_INFER = False
