...
from .kitti_utils import Calibration, read_label, approx_proj_center, refresh_attributes, show_heatmap, \
    show_image_with_boxes, show_edge_heatmap
    ...
    def __getitem__(self, idx):
        ...
        for i, obj in enumerate(objs):
            ...
            if self.filter_annos:
                if float_truncation >= self.filter_params[0] and (box2d[2:] - box2d[:2]).min() <= self.filter_params[
                    1]: continue
